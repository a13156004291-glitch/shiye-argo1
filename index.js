...
const SUB_PATH = process.env.SUB_PATH || 'shiye';       // 订阅路径
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'suidao.shiyeo1.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMGJkMGEyYWI5OWFhMzgyNWU1MGJkODViNzdkMTNiOGEiLCJ0IjoiZmY5ZWEzMjktYzQ1Yi00ZGFhLWIxZWEtODVjMzUwNmIyMjExIiwicyI6Ik1HVXpZVFJqWlRndFlUTm1OQzAwTlRRd0xXSXpaREF0T0dJM1l6VTNPVEV4T1RsaSJ9
...
const NAME = process.env.NAME || 'shiyesuidao';                        // 节点名称
